...
=== Servers and rack
...

  {
    ...
    "REQUEST_PATH"    =>"/",                  # Where to go on my
                                              # application    
    ...
    "HTTP_USER_AGENT" =>"Mozilla/5.0 [...]",  # This was the browser I made
                                              # the request with
    "HTTP_COOKIE"     =>"BAh7CU3[...]",       # My cookie:
                                              # an encrypted string
    # ... and so on ...
  }
=end
def session6_02_servers_and_rack;end
end