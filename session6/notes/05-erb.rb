...
===
  ...
  # For lines where you don't want to keep the output,
  # like the line that iterates over the shopping cart,
  # you put your Ruby inside tags.
...
===
  ...
  #  For lines where you want to embed the output,
  #  put your code inside of tags.
