...
#### Initializing with Class methods
...
#### replace a range of indexes with elements from an array (size doesn't need to match)
...
#### Adding / Removing / Replacing / Finding elements (never have to write a stack again)
