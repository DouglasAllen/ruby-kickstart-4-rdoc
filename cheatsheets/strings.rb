...
=== Ruby String Class
  ...
  'trite'.gsub('t','b')                         
  # => "bribe"
  "Their IDs are 11, and 492".scan(/\d+/)       
  # => ["11", "492"]
  "Jack and Jill ran up the hill".split         
  # => ["Jack", "and", "Jill", "ran", "up", "the", "hill"]
  "/usr/bin:/opt/local:/Users/josh".split(':')  
  # => ["/usr/bin", "/opt/local", "/Users/josh"]
  "abcdefg hi".split(//)                        
  # => ["a", "b", "c", "d", "e", "f", "g", " ", "h", "i"]

=end
def cheat_sheets_strings;end
end