...
===
  ...
  # instead,
  # implement your own by creating a hash table of elements,
  # from the first set and checking it against the elements,
  # from the second set.
  #
  # The keys will be the elements in the arrays.
  # Each value will be a two element array,
  # where the first index is true if the key is in a,
  # and the second is true if the key is in b.
  # If an index is not true, it should be nil.
  #
  # Return the hash, and the array of elements in both sets
  # (it should be sorted)
  # (do not worry about the order of the hash,
  # remember, on 1.8, hashes have no ordering)
  #
  # hints: 
  ...
  # => [ { 'a'=>[true,nil] ,
           ...
           ['b','d'] ]
  shared [] , [1,2]                     
  # => [ { 1=>[nil,true] , 2=>[nil,true] } , [] ]
  shared [1,2] , []                     
  # => [ { 1=>[true,nil] , 2=>[true,nil] } , [] ]
  shared [] , []                        
  # => [ { } , [] ]
  shared [1,2,:c] , ['a','b',:c]        
  # => [ { 1=>[true,nil] ,
