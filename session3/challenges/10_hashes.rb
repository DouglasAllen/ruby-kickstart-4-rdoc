...
===
  ...
  # all of the complete file paths where each directory is separated
  # by a '/'
  #
  # HINT:
  ...
  # HINT2:
  # Don't feel constrained, you may create any methods,
  # classes, etc, that you need to.
  # You may address the problem in any way you need to.
  # (I haven't tried it yet,
  #  but will probably use a recursive approach)
  #
  # EXAMPLES:
