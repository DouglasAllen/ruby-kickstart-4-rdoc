...
=begin
===
  # Build your own sort method.
  # It does not have to be fancy, any sort will do.
  # There are many listed here:
  # http://en.wikipedia.org/wiki/Sorting_algorithm#Summaries_of_popular_sorting_algorithms
  # 
  # The purpose is to let the user customize how you sort the array,
  # by submitting a block that tells you which element goes first.
  #
  # If a block is given ,
  # it should use the block to determine what order the elements
  # should be sorted by.
  # 
  ...
  #
  # EXTRA POINTS FOR:
  #   normalizing the input (the proc) at the start,
  #   rather than checking to see if it is there every time
  #   you wish to use it.
  #  (hint: if no block is submitted, the proc variable will be nil)
  #
  #
  # EXAMPLE: 
  #
  ...
  # RED, GREEN, REFACTOR
  # placing all strings first, integers second, and floats last,
  # each sorted within themselves
