...
===
  ...
  # you must get which one it is from a hash.
  ...
  # => 2
  problem_14 1, 1, 2, 1, 1      , :problem => :count_clumps 
  # => 2
  problem_14 1, 1, 1, 1, 1      , :problem => :count_clumps
  # => 1
  #
  # I can also bypass your problem_14 method and go directly to
  # count_clumps as so:
  ...
  #
  # Return true,
  # if the group of N numbers at the start and end of the array,
  # are the same. 
  ...
  # the rest will be the input to look for ends from
  problem_14 1, 5, 6, 45, 99, 13, 5, 6   , :problem => :same_ends
  # => false
  problem_14 2, 5, 6, 45, 99, 13, 5, 6   , :problem => :same_ends
  # => true
  problem_14 3, 5, 6, 45, 99, 13, 5, 6   , :problem => :same_ends
  # => false
  #
  # I can also bypass your problem_14 method
  # and go directly to same_ends as so:
...
=end
def session3_14_var_args_and_hash;end
end