class HTMLTag
  ...
  # options is a hash tag that allows the user to specify whether
  # they want this tag to span multiple lines
  # example when args are:
  # 'p' , 'hello world' , :multiline => false
  
  # <p >hello world</p>
  # 
  # example when args are:
  # 'p' , 'hello world' , :multiline => true
  ...
  def font
    font = options[:font]   # one of :serif , :sans_serif , :monospace,
                            # or nil if it doesn't exist
    FONTS[font]             # look up the user defined result
                            # in our FONTS hash to get the css
  end
  ...
  # convert our HTMLTag to a String (in this case,
  # it is represented as HTML)
  def to_s
    # remember, if options[:multiline] doesn't exist,
    # it will return nil, and nil is false
...
sports = [
  ...
  HTMLTag.new('li', 'soccer'                       ) ,  # no multiline here,
