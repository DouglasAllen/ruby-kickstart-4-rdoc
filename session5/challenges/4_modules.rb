...
===
  ...
  # 
  # Your mission then, is to write a module, 
  # OperatorGeneratorFromSpace, that uses the spaceship operator <=>
  # to write the methods < , <= , == , > , and >=
  #
  # The spaceship operator takes two arguments and returns -1, 0, 1
  # depending on whether the left argument is less than, equal to,
