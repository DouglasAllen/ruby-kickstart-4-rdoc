...
=== Module example
  ...
  sequence.singleton_class.ancestors  
  # => [Threes, Range, Enumerable, Object, Kernel, BasicObject]
  (0...30).singleton_class.ancestors  
...
=end
def session5_04_module_example;end
end