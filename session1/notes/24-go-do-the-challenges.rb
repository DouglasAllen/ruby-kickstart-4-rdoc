...
=== Do the challenges
  ...
  # Open up the challenges in your text editor.
  # Try to complete the first one.
  # Then go to the terminal,
  # and navigate to the directory with the Rakefile in it.
  # Then run 
  ...
  # !!!!!!!!!!DON'T FORGET!!!!!!!!!
  # There are cheatsheets to help you.
  # You may need to reference them!
  # If you don't like them, make your own.
  # You'll learn a great deal that way too.
  
  # Question:
  #  How should you use the cheatsheets?
  
  # Read them once so you know what kinds of things they contain.
  # Then when you need to use something,
  # first try to remember what it was.
  
  # If you can't remember, then go look it up.
  # Make a point of focusing on the answer,
  # and try to recall it again immediately.
  # This will help you quickly learn the things you want to use.  
  # You don't need to sit down and try to memorize the whole sheet.
  # (if you want to, you may)
  # The general things they contain will be good to memorize like,
  # what they are about, and what is common to most objects.
...
=end
def session1_24_go_do_the_challenges;end
end
