...
=== Scope
  ...
  # Well that seems pretty useless, eh?
  # Fortunately, there is an internet connection on this world!
  # You can pass objects, into the method.
  # When we pass an object in, the variable that points to it 
  ...
  beam_me_up("Ryker", "Data") 
  # => "The away team consists of Ryker and Data."
=end
def session1_06_method_scope;end
end