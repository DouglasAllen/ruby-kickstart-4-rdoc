...
http://www.yourdictionary.com/ruby#computer
  # =>
  #  Origins of the Ruby Language:
  #   Written By:
  #    Matz (Yukihiro Matsumoto) in 1993.
  #     First Public Release:
  #      1995
  
  #  Ruby is:
  #     * dynamic (interpreted)
  #     * strongly typed (mostly)
  #     * dynamically typed (known as duck typing)
  ...
  #  Why Ruby?
  #   It's hot! 
  #   One of my instructors just sent this to 
  #   our school's ACM mailing list:
  #
  ...
  #     
  #     Source: 
  #     Dice.com via May 9, 2011 ComputerWorld
  ...
  #   development, it was beautiful and elegant in the face of
  #   "spaghetti code" prominent in the web domain,
  #   and because it cared enough to do things "right" even when that
  #   meant thinking completely outside what had been done before
  #   and pushing boundaries. 
 
  #   Think about it, you can conceive of your own problems.
  #   And you can solve them.
  #   You can create anything you can conceive of,
  #   like a brilliant architect.
  
  #   "Whoever holds the keys to programming ends up building 
  #   the reality in which the rest of us live."
  #   -- Douglas Rushkoff
=end  
def session1_01_intro;end 
end
