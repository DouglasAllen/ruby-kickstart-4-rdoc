class ChallengesSession04
=begin
===
  # In Ruby on Rails, when a person goes to a URL on your site, 
  # your application looks at the url, and maps it to a controller
  # method to handle the request.
  #
  # My boss wanted to be able to specify what CSS class the body
  # of the HTML output should have, based on which controller method
  # was being accessed. It fell to me to provide a method, 
  # which, when invoked, would return a String that could handle the request.
  # 
  ...
  # The String you return should know how to add new classes:
...
=end
def session4_06_singleton_class_string;end
end