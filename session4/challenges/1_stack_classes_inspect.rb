...
===
  ...
  # where when you add a new object to the collection,
  # called "pushing",
  # it becomes the first object that you remove from the collection,
  # called "popping".
  ...
  stack.push 2
  stack         
  # => #<Stack:0x00000100862698 @head=#<Node:0x00000100862648 @next=#<Node:0x00000100862670 @next=nil, @data=1>, @data=2>>
  stack.pop     # => 2
  stack.pop     # => 1
  stack.pop     # => nil
...
=end
def session4_01_stack_classes_inspect;end
end
